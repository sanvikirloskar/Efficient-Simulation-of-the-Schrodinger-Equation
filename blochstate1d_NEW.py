...
class OLConstants(QuantumConstants):
    ...
    N_individuals = 20 #This is A in the genetic algorithm part of Carries thesis 
    N_elements = 150 
    T: float = 10.0
    @property
    def unit_cell(self):
...
class GroundBlochState():
    ...
    def generate_bloch_state(self, spacial_dims=2): # if you don't specify the dimensions it will automatically be 1d, but 2d can be called explicitly
