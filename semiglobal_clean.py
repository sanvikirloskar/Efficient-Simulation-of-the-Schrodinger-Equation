...
from quevolutio.core import domain
...
from crab_propagation_tools_semiglobal import OpticalLatticeHamiltonian, make_controls_fn
...
def get_error(coeffs, omegas, N_basis, mom_pop_des = OLConstants().desired_mom_pop):
    ...
    controls_fn = make_controls_fn(N_basis, coeffs, omegas, time_domain.time_max) # shaking func
...
print('no shaking error:', error1)
print('with shaking error:', error2)
print()