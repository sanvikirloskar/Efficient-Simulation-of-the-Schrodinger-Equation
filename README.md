...
Data Included:
--------------
- GA data: best fitnesses for all $r_m$ variations recorded, fitnesses for all $A_{die}$ variations recorded, example of a shaking function with fitness 0.11 (best_solution.npz). Contained in folder Project_data
